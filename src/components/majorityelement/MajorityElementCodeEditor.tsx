...
export default function MajorityElementCodeEditor() {
  const [code, setCode] = useState(`function majorityElement(nums: number[]): number {
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-slate-200">
        ...
        <textarea
          ...
          className="w-full h-64 p-4 font-mono text-sm bg-slate-900 text-green-400 rounded-lg border-2 border-slate-300 focus:outline-none focus:border-violet-500"
          spellCheck={false}
        />
            ...
            <div className="mt-6 bg-gradient-to-r from-green-500 to-emerald-500 text-white p-6 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>Semua test cases lulus. Boyer-Moore-mu berjalan baik.</p>
                </div>
              </div>
            </div>
          )}
