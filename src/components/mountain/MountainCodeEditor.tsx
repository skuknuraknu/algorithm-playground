...
export default function MountainCodeEditor() {
  const [userCode, setUserCode] = useState(`function validMountainArray(arr) {
  ...
  const [testResults, setTestResults] = useState<
    Array<{ passed: boolean; output: boolean; expected: boolean; input: number[] }>
  >([]);
