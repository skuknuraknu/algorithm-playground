...
export default function SingleNumberCodeEditor() {
  const [code, setCode] = useState(`function singleNumber(nums: number[]): number {
  // Write your solution here
  // Tip: think about XOR properties
  return 0;
}`);
  ...
  const testCases = [
    ...
    { input: [7, 3, 5, 3, 5, 7, 9], expected: 9 },
            ...
            <div className="mt-6 bg-gradient-to-r from-green-500 to-emerald-500 text-white p-6 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>Semua test cases lulus. Solusimu berhasil!</p>
                </div>
              </div>
            </div>
          )}
